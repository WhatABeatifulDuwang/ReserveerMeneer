            ...
            @endif
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form action="{{ route('postFilmStore') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="col-span-1">
                                    <div class="form-group">
                                        <input type="text" class="form-control w-full" name="hallId" placeholder="Zaalnummer">
                                    </div>
                                </div>
                                <div class="col-span-1">
                                    <div class="form-group">
                                ...
                                <div class="col-span-1 text-right">
                                    <a href="{{ route('postFilmStore') }}" class="bg-white hover:bg-gray-100 text-gray-800 py-2 px-4 border border-gray-400 rounded shadow">
                                        Aanpassen
                                    </a>
                                </div>
                            </div>
